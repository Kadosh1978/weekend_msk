...
route, route_created = Route.objects.update_or_create(
    ...
    defaults={
        ...
        "route_image_1_caption": (
            "<strong>Тульский кремль</strong><br>Историческое сердце города и логичное начало маршрута."
        ),
        "route_image_2_caption": (
            "<strong>Музей оружия</strong><br>Одна из главных современных достопримечательностей Тулы."
        ),
        "route_image_3_caption": (
            "<strong>Казанская набережная</strong><br>Отличное место для прогулки во второй половине дня."
        ),
        "content": (
            "Маршрут построен так, чтобы за один день увидеть главную Тулу: кремль, музей оружия, прогулочный центр, пряничные лавки и спокойное возвращение в Москву вечером.\n\n"
            "Почему стоит поехать.\n"
            "Тула хорошо подходит для насыщенной, но понятной поездки выходного дня. Здесь легко совместить историю, городскую прогулку, музеи и гастрономию: всё главное находится достаточно близко, поэтому день получается разнообразным, но не хаотичным.\n\n"
