...
route, route_created = Route.objects.update_or_create(
    ...
    defaults={
        ...
        "content": (
            "Маршрут рассчитан на два дня: первый день — для главных мест Каширы и вечерней прогулки, второй — для окрестностей, дополнительных храмов и более спокойного знакомства с городом.\n\n"
            "Почему стоит поехать.\n"
            "Двухдневный формат подходит тем, кто не хочет спешить и готов посмотреть Каширу глубже. За это время город раскрывается не только через главные достопримечательности, но и через тихие улицы, виды на Оку, небольшие музеи и поездки по окрестностям.\n\n"
